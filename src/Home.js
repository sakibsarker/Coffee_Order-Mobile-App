import { View, Text,Image,TouchableOpacity,TextInput,StyleSheet,Modal,Alert,Pressable } from 'react-native'
...
const Home = ({navigation}) => {
  ...
  const ModelD=()=>{
    ...
    return(
      ...
      >
         <Entypo style={{marginLeft:230}} name='sound' size={25} color={'red'}/>
      </Pressable>
    </View>
    )
  }
